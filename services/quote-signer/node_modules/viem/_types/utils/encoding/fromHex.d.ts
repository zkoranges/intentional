import { type IntegerOutOfRangeErrorType, type InvalidHexBooleanErrorType, type SizeOverflowErrorType } from '../../errors/encoding.js';
...
export type HexToNumberErrorType = HexToBigIntErrorType | IntegerOutOfRangeErrorType | ErrorType;
/**
