...
import { type BlockParameters, type VerifyHashErrorType, type VerifyHashParameters } from './verifyHash.js';
export type VerifyTypedDataParameters<typedData extends TypedData | Record<string, unknown> = TypedData, primaryType extends keyof typedData | 'EIP712Domain' = keyof typedData> = Omit<VerifyHashParameters, 'blockHash' | 'blockNumber' | 'blockTag' | 'hash' | 'requireCanonical'> & BlockParameters & TypedDataDefinition<typedData, primaryType> & {
