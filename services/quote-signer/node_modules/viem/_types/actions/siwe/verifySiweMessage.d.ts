...
import { type BlockParameters, type VerifyHashErrorType } from '../public/verifyHash.js';
export type VerifySiweMessageParameters = Prettify<Pick<ValidateSiweMessageParameters, 'address' | 'domain' | 'nonce' | 'scheme' | 'time'> & {
    /**
